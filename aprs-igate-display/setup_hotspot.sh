#!/bin/bash
# WiFi Hotspot Setup for APRS iGate Display
# Creates a WiFi access point on the Raspberry Pi Zero W

set -e

echo "=== APRS iGate Display - WiFi Hotspot Setup ==="
echo ""

# Configuration
SSID="APRSiGate-AP"
PASSWORD="aprsgate123"
CHANNEL=6
...
echo ""
echo "⚠️  IMPORTANT: Amateur Radio License Required"
echo "Ensure you have a valid amateur radio license before operating"
echo ""
